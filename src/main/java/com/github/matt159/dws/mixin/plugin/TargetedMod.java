...
public enum TargetedMod implements ITargetedMod {
    ...
    BAUBLESEXPANDED      ("Baubles Expanded"       , true  , startsWith("baublesexpanded").and(contains("mega").negate())),
    BAUBLESEXPANDED_MEGA ("Baubles Expanded (MEGA)", true  , startsWith("baublesexpanded-mega")),
